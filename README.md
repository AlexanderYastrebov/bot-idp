...
```console
$ DEBUG=1 DIFFICULTY=16 ADDRESS=:4159 SECRET=$(head -c 32 /dev/urandom | base64 | tr '/+' '_-' | tr -d '=') CLIENT_ID=bot-idp CLIENT_SECRET=secret1 ISSUER=http://localhost:4159 go run .
